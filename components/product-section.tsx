...
/**
 * Sección de Productos. `modo="home"` muestra el carrusel de siempre;
 * `modo="pagina"` muestra la lista completa en filas apiladas con scroll
 * parallax, pensado para usarse dentro de /productos.
 */
export function ProductSection({ modo = "pagina" }: { modo?: "home" | "pagina" }) {
  ...
  const espaciado =
    modo === "home" ? "py-24 md:py-32" : "pb-24 pt-32 md:pb-32 md:pt-40";

  return (
    <section id="productos" className={`relative overflow-hidden bg-bg ${espaciado}`}>
      <SectionBg src={txt(c.fondo, "")} posicion={txt(c.fondo_posicion, "50% 50%")} />
